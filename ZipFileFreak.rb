...
# By: Osanda Malith Jayathissa (@OsandaMalith)
#
...
def banner
  puts
  puts "[+] ZipFile Freak"
  puts "[+] Osanda Malith Jayathissa (@OsandaMalith)"
  puts "[+] OsandaJayathissa@gmail.com"
end


def cls
  system(if RUBY_PLATFORM =~ /win32|win64|WoW64|\.NET|windows/i then 'cls' else 'clear' end)
end
